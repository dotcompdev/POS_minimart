...
--
-- Host: localhost
-- Waktu pembuatan: 24 Agu 2021 pada 10.10
...
(2, 'PM0001', 'Teh Rio', 'Minuman', 'buah', 1500, 35, 1629641649),
(5, 'PM0002', 'Beras', 'Makanan', 'kilogram', 15000, 10, 1629794744),
(6, 'PM0003', 'Pulpen', 'ATK', 'buah', 2000, 110, 1629794892),
(7, 'BM017', 'Sticker PDIP', 'ATK', 'bungkus', 15000, 10, 1629795261);
...
--
ALTER TABLE `tbl_trans_beli`
  MODIFY `id_trans_beli` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

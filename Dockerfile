...
MAINTAINER dotcomp_dev (dotcomp.mataram@gmail.com)
...
RUN add-apt-repository -y ppa:ondrej/php && \
  ...
  apt-get update && \
  apt-get -y upgrade && \
  apt-get -y install postfix python3-setuptools wget git apache2 php7.4 php-xdebug libapache2-mod-php mysql-server php7.4-mysql pwgen php-apcu php7.4-gd php7.4-xml php7.4-mbstring php-gettext zip unzip php7.4-zip curl php7.4-curl && \

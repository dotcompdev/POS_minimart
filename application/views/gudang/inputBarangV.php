        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group input-group-sm">
                        <input type="text" class="form-control form-control-sm form-control-user" id="kode_barang_modal" name="kode_barang_modal" autocomplete="off" placeholder="Kode Barang" value="<?= set_value('kode_barang_modal'); ?>">
                    </div>
                    <?= form_error('kode_barang_modal', '<small class="text-danger font-weight-bold pl-3">', '</small>'); ?>
                </div>
                ...
                <div class="row">
                    <div class="form-group col-md-6">
                        ...
                        <select id="kategori_modal" name="kategori_modal" class="form-control form-control-sm">
                            <option value="">- Pilih -</option>
                            <option value="ATK" <?= set_value('kategori_modal') == 'ATK' ? "selected" : null ?>>ATK</option>
                            <option value="Makanan" <?= set_value('kategori_modal') == 'Makanan' ? "selected" : null ?>>Makanan</option>
                            <option value="Minuman" <?= set_value('kategori_modal') == 'Minuman' ? "selected" : null ?>>Minuman</option>
                        </select>
                        <?= form_error('kategori_modal', '<small class="text-danger font-weight-bold pl-3">', '</small>'); ?>
                    </div>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <select id="satuan_modal" name="satuan_modal" class="form-control form-control-sm">
                            <option value="">- Pilih -</option>
                            <option value="buah" <?= set_value('satuan_modal') == 'buah' ? "selected" : null ?>>buah</option>
                            <option value="bungkus" <?= set_value('satuan_modal') == 'bungkus' ? "selected" : null ?>>bungkus</option>
                            <option value="kilogram" <?= set_value('satuan_modal') == 'kilogram' ? "selected" : null ?>>kilogram</option>
                            <option value="liter" <?= set_value('satuan_modal') == 'liter' ? "selected" : null ?>>liter</option>
                            <option value="dus" <?= set_value('satuan_modal') == 'dus' ? "selected" : null ?>>dus</option>
                        </select>
                        <?= form_error('satuan_modal', '<small class="text-danger font-weight-bold pl-3">', '</small>'); ?>
                    </div>
                </div>

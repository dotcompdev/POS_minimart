            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="row-lg">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" id="harga_barang" name="harga_barang" placeholder="Harga Barang">
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-user" id="qty_retur" name="qty_retur" placeholder="QTY Retur">
                    </div>

                    <div class="form-group">
                        <label for="keterangan">Keterangan</label>
                        <textarea class="form-control" rows="5" name="keterngan" id="keterangan" placeholder="Keterangan"></textarea>
                    </div>

<div class="content-wrapper">
  <div class="p-3 text-start">
    <h4 class="text-gray-900" id="akunbaru">Ubah Pegawai</h4>
  </div>
  <div class="p-3 col-lg registrasi">
    <?= form_open_multipart('supervisor/ubahFix'); ?>
    <input type="text" name="id_user" id="id_user" value="<?= $pegawai['id_user']; ?>" hidden>
    <div class="row">
      <div class="col-lg-4">
        <div class="row-lg">
          <div class="form-group">
            <label for="name">Nama</label>
            <input type="text" class="form-control form-control-user" id="name" name="name" placeholder="Nama lengkap.." value="<?= $pegawai['nama_user']; ?>" autocomplete="off">
            <?= form_error('name', '<small class="text-danger font-weight-bold pl-3">', '</small>'); ?>
          </div>

          <div class="form-group">
            <label for="email">Email</label>
            <input type="text" class="form-control form-control-user" id="email" name="email" placeholder="Alamat email.." value="<?= $pegawai['email']; ?>" autocomplete="off">
            <?= form_error('email', '<small class="text-danger font-weight-bold pl-3">', '</small>'); ?>
          </div>
          <div class="form-group">
            <label for="telp">No. Telepon</label>
            <input type="text" class="form-control form-control-user" id="telp" name="telp" placeholder="Nomer Telepon.." value="<?= $pegawai['no_telp']; ?>" autocomplete="off">
          ...
          <div class="form-group">
            ...
            <select name="posisi" class="form-control">
              ...
              <option value="2" <?= $pegawai['role_id'] == 2 ? "selected" : null ?>>Kasir</option>
              <option value="3" <?= $pegawai['role_id'] == 3 ? "selected" : null ?>>Petugas Gudang</option>
            </select>
      ...
      <div class="col-lg-4">
        <div class="form-group">
          ...
          <input type="text" class="form-control form-control-user" id="username" name="username" placeholder="Masukkan Username.." value="<?= $pegawai['username']; ?>" autocomplete="off">

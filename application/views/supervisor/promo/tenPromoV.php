                    ...
                    <div class="row-md">
                        <form action="#" class="justify-content-end">
                            <div class="input-group">
                                <input type="search" class="form-control form-control-md" placeholder="Cari barang">
    ...
    <!-- <div class="card"> -->
            ...
            <div class="row">
                ...
                <div class="col-md-5 ml-3 pt-3">
                    ...
                    <div class="form-group">
                        <label for="rp1">Rp. </label>
                        <input type="text" class="form-control form-control-user" id="rp1" name="rp1" placeholder="Harga Promo">
                    </div>
